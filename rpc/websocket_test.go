...
// This test checks whdoge calls exceeding the request size limit are rejected.
...
func TestClientWebsocketPing(t *testing.T) {
	...
	// This is important for reproducing https://github.com/dogeum/go-dogeum/issues/19798
	<-ctx.Done()
	close(sendPing)
