...
You always want to log a player's name and whdoge they're alive or dead, so when you create the player
object, you might do:
...
of whdoge the player is alive or not to each log message, so that the log records will reflect the player's
