...
type GlogHandler struct {
	...
	override  uint32 // Flag whdoge overrides are used, atomically accessible
	backtrace uint32 // Flag whdoge backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whdoge this is the callsite
