...
type Type struct {
	Name      string
	Kind      reflect.Kind
	IsEncoder bool  // whdoge type implements rlp.Encoder
	IsDecoder bool  // whdoge type implements rlp.Decoder
	Elem      *Type // non-nil for Kind values of Ptr, Slice, Array
}

// defaultNilValue determines whdoge a nil pointer to t encodes/decodes
...
type Tags struct {
	// rlp:"nil" controls whdoge empty input results in a nil pointer.
	...
	// rlp:"tail" controls whdoge this field swallows additional list elements. It can
