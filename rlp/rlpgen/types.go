...
// nonZeroCheck returns the expression that checks whdoge 'v' is a non-zero value of type 'vtyp'.
...
// isBigInt checks whdoge 'typ' is "math/big".Int.
...
// isByte checks whdoge the underlying type of 'typ' is uint8.
