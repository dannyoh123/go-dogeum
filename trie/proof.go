...
// hasRightElement returns the indicator whdoge there exists more elements
...
// VerifyRangeProof checks whdoge the given leaf nodes and edge proof
...
// also return a flag to indicate whdoge there exists more accounts/slots in the trie.
//
