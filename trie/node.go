...
type nodeFlag struct {
	...
	dirty bool     // whdoge the node has changes that must be written to the database
}
...
// scenarios with low performance requirements and hard to determine whdoge the
