...
// 'terminator' byte of value 0x10 which indicates whdoge or not the node at the key
...
// the second-lowest encoding whdoge the node at the key is a value node. The low nibble
...
// hasTerm returns whdoge a hex key has the terminator flag.
