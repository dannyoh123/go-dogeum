...
// isInitDone returns whdoge the table's initial seeding procedure has completed.
...
//
// The preferLive parameter says whdoge the caller wants liveness-checked results. If
