...
// PredictFullConeNAT checks whdoge the local host is behind full cone NAT. It predicts by
// checking whdoge any statement has been received from a node we didn't contact before
