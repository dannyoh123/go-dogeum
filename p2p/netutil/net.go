...
// Contains reports whdoge the given IP is contained in the list.
...
// IsLAN reports whdoge an IP is a local network address.
...
// IsSpecialNetwork reports whdoge an IP is located in a special-use network range
...
// CheckRelayIP reports whdoge an IP relayed from the given sender IP
...
// SameNet reports whdoge two IP addresses have an equal prefix of the given bit length.
...
// Contains whdoge the given IP is contained in the set.
