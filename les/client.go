...
import (
	...
	"github.com/dogeum/go-dogeum/les/downloader"
	"github.com/dogeum/go-dogeum/les/vflux"
...
// prenegQuery sends a capacity query to the given server node to determine whdoge
...
// Dogebase is the address that mining rewards will be send to
func (s *LightDummyAPI) Dogebase() (common.Address, error) {
	return common.Address{}, fmt.Errorf("mining is not supported in light mode")
}

// Coinbase is the address that mining rewards will be send to (alias for Dogebase)
