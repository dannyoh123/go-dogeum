...
import (
	...
	"github.com/dogeum/go-dogeum/core/forkid"
	"github.com/dogeum/go-dogeum/core/types"
	"github.com/dogeum/go-dogeum/les/flowcontrol"
	"github.com/dogeum/go-dogeum/les/utils"
	vfc "github.com/dogeum/go-dogeum/les/vflux/client"
	vfs "github.com/dogeum/go-dogeum/les/vflux/server"
...
type peerCommons struct {
	*p2p.Peer
	...
	frozen       uint32    // Flag whdoge the peer is frozen.
...
// canQueue returns an indicator whdoge the peer can queue an operation.
...
func (p *peerCommons) handshake(td *big.Int, head common.Hash, headNum uint64, genesis common.Hash, forkID forkid.ID, forkFilter forkid.Filter, sendCallback func(*keyValueList), recvCallback func(keyValueMap) error) error {
	...
	// as well. Check http://eips.dogeum.org/EIPS/eip-2124 for more
	// spec detail.
	if p.version >= lpv4 {
...
type serverPeer struct {
	...
	// Status fields
	trusted                 bool   // The flag whdoge the server is selected as trusted server.
	onlyAnnounce            bool   // The flag whdoge the server sends announcement only.
	...
	// Test callback hooks
	hasBlockHook func(common.Hash, uint64, bool) bool // Used to determine whdoge the server has the specified block.
}
