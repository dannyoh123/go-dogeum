...
type nodeDB struct {
	...
	evictCallBack func(mclock.AbsTime, bool, utils.ExpiredValue) bool // Callback to determine whdoge the balance can be evicted.
	clock         mclock.Clock
	closeCh       chan struct{}
...
// expireNodes iterates the whole node db and checks whdoge the
