...
// checkCallbacks checks whdoge the threshold of any of the active callbacks
...
// checkPriorityStatus checks whdoge the node has gained priority status and sets the priority
