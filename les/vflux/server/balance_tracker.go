...
import (
	...
	"github.com/dogeum/go-dogeum/p2p/nodestate"
)
...
// BalanceOperation allows atomic operations on the balance of a node regardless of whdoge
...
// canDropBalance tells whdoge a positive or negative balance is below the threshold
