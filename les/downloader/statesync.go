...
// stateReq represents a batch of state fetch requests grouped togdoge into
...
type stateReq struct {
	...
	dropped   bool                      // Flag whdoge the peer dropped off early
}
...
// delivered. Returns whdoge the peer actually managed to deliver anything of
...
// peer into the state trie, returning whdoge anything useful was written or any
// error occurred.
//
