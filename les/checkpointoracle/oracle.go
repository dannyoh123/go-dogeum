...
type CheckpointOracle struct {
	...
	running  int32                                 // Flag whdoge the contract backend is set or not
...
// IsRunning returns an indicator whdoge the oracle is running.
...
// checks whdoge there are enough approvals to finalize the checkpoint.
