...
import (
	...
	"github.com/dogeum/go-dogeum/les/fetcher"
...
func (f *lightFetcher) mainloop() {
	...
	var (
		...
		syncing      bool        // Indicator whdoge the client is syncing
	...
	// trustedHeader returns an indicator whdoge the header is regarded as
