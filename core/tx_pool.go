...
const (
	...
	// to validate whdoge they fit into the pool or not.
...
type TxPoolConfig struct {
	...
	NoLocals  bool             // Whdoge local transaction handling should be disabled
...
type TxPool struct {
	...
	istanbul bool // Fork indicator whdoge we are in the istanbul stage.
	eip2718  bool // Fork indicator whdoge we are using EIP-2718 type transactions.
	eip1559  bool // Fork indicator whdoge we are using EIP-1559 type transactions.
...
// validateTx checks whdoge a transaction is valid according to the consensus
...
// and returns whdoge it was inserted or an older was better.
//
// Note, this method assumes the pool lock is held!
...
// Has returns an indicator whdoge txpool has a transaction cached with the
// given hash.
...
// should return the indicator whdoge the iteration needs to be continued.
