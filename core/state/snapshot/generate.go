...
type proofResult struct {
	...
	proofErr error      // Indicator whdoge the given state range is valid or not
...
// last returns the last verified element key regardless of whdoge the range proof is
