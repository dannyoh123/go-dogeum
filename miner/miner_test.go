...
import (
	...
	"github.com/dogeum/go-dogeum/ethdb/memorydb"
...
// TestMinerSetDogebase checks that dogebase becomes set even if mining isn't
// possible at the moment
func TestMinerSetDogebase(t *testing.T) {
	miner, mux, cleanup := createMiner(t)
	defer cleanup(false)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux, func(skipMiner bool)) {
	...
	config := Config{
		Dogebase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
