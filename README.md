...
)](https://pkg.go.dev/github.com/dogeum/go-dogeum?tab=doc)
[![Go Report Card](https://goreportcard.com/badge/github.com/dogeum/go-dogeum)](https://goreportcard.com/report/github.com/dogeum/go-dogeum)
...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://geth.dogeum.org/docs/install-and-build/installing-geth).
...
[CLI Wiki page](https://geth.dogeum.org/docs/interface/command-line-options)),
 ...
 * Start up `geth`'s built-in interactive [JavaScript console](https://geth.dogeum.org/docs/interface/javascript-console),
   (via the trailing `console` subcommand) through which you can interact using [`web3` methods](https://github.com/ChainSafe/web3.js/blob/0.20.7/DOCUMENTATION.md) 
   (note: the `web3` version bundled within `geth` is very old, and not up to date with official docs),
   as well as `geth`'s own [management APIs](https://geth.dogeum.org/docs/rpc/server).
...
and [`geth` specific APIs](https://geth.dogeum.org/docs/rpc/server)).
...
and the [ethminer](https://github.com/dogeum-mining/ethminer) repository.
...
```shell
$ geth <usual-flags> --mine --miner.threads=1 --miner.dogebase=0x0000000000000000000000000000000000000000
```

Which will start mining blocks and transactions on a single CPU thread, crediting all
proceedings to the account specified by `--miner.dogebase`. You can further tune the mining
...
Please see the [Developers' Guide](https://geth.dogeum.org/docs/developers/devguide)
