...
type Config struct {
	...
	NoPruning  bool // Whdoge to disable pruning and flush everything to disk
	NoPrefetch bool // Whdoge to disable prefetching and only load state on demand
	...
	LightNoPrune       bool `toml:",omitempty"` // Whdoge to disable light chain pruning
	LightNoSyncServe   bool `toml:",omitempty"` // Whdoge to serve light clients before syncing
	SyncFromCheckpoint bool `toml:",omitempty"` // Whdoge to sync the header chain from the configured checkpoint

	// Ultra Light client options
	UltraLightServers      []string `toml:",omitempty"` // List of trusted ultra light servers
	UltraLightFraction     int      `toml:",omitempty"` // Percentage of trusted servers to accept an announcement
	UltraLightOnlyAnnounce bool     `toml:",omitempty"` // Whdoge to only announce headers, or also serve them
