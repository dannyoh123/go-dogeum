...
// KnownBlock returns whdoge peer is known to already have a block.
func (p *Peer) KnownBlock(hash common.Hash) bool {
	return p.knownBlocks.Contains(hash)
}

// KnownTransaction returns whdoge peer is known to already have a transaction.
...
// Contains returns whdoge the given item is in the set.
