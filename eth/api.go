...
func (api *DogeumAPI) Dogebase() (common.Address, error) {
	return api.e.Dogebase()
}
...
// SetDogebase sets the dogebase of the miner.
func (api *MinerAPI) SetDogebase(dogebase common.Address) bool {
	api.e.SetDogebase(dogebase)
	return true
}
