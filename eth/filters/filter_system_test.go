...
// TestPendingTxFilter tests whdoge pending tx filters retrieve all pending transactions that are posted to the event mux.
...
// TestLogFilterCreation test whdoge a given filter criteria makes sense.
...
// TestInvalidLogFilterCreation tests whdoge invalid filter log criteria results in an error
...
// TestLogFilter tests whdoge log filters match the correct logs that are posted to the event feed.
