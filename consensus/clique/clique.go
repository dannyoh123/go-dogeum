...
// VerifyHeader checks whdoge a header conforms to the consensus rules.
...
// verifyHeader checks whdoge a header conforms to the consensus rules.The
...
// verifySeal checks whdoge the signature contained in the header satisfies the
