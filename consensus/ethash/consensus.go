...
import (
	...
	"github.com/dogeum/go-dogeum/common/math"
...
var (
	...
	PopcatBlockReward, _          = big.NewInt(0).SetString("50000000000000000000", 10) // Block reward in wei for successfully mining a block upward from Popcat
	maxUncles                     = 2                                                   // Maximum number of uncles allowed in a single block
	allowedFutureBlockTimeSeconds = int64(15)                                           // Max seconds from current time allowed for blocks, before they're considered future blocks

	// calcDifficultyEip5133 is the difficulty adjustment algorithm as specified by EIP 5133.
	// It offsets the bomb a total of 11.4M blocks.
	// Specification EIP-5133: https://eips.dogeum.org/EIPS/eip-5133
	...
	// Specification EIP-4345: https://eips.dogeum.org/EIPS/eip-4345
	calcDifficultyEip4345 = makeDifficultyCalculator(big.NewInt(10_700_000))

	// calcDifficultyEip3554 is the difficulty adjustment algorithm as specified by EIP 3554.
	// It offsets the bomb a total of 9.7M blocks.
	// Specification EIP-3554: https://eips.dogeum.org/EIPS/eip-3554
	calcDifficultyEip3554 = makeDifficultyCalculator(big.NewInt(9700000))

	// calcDifficultyEip2384 is the difficulty adjustment algorithm as specified by EIP 2384.
	// It offsets the bomb 4M blocks from Constantinople, so in total 9M blocks.
	// Specification EIP-2384: https://eips.dogeum.org/EIPS/eip-2384
	...
	// bomb offset 5M.
	// Specification EIP-1234: https://eips.dogeum.org/EIPS/eip-1234
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(5000000))

	// calcDifficultyByzantium is the difficulty adjustment algorithm. It returns
	// the difficulty that a new block should have when created at time given the
	// parent block's time and difficulty. The calculation uses the Byzantium rules.
	// Specification EIP-649: https://eips.dogeum.org/EIPS/eip-649
...
// VerifyHeader checks whdoge a header conforms to the consensus rules of the
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/dogeum/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
		...
		// Specification: https://eips.dogeum.org/EIPS/eip-1234
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/dogeum/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
...
// verifySeal checks whdoge a block satisfies the PoW difficulty requirements,
