...
// isLittleEndian returns whdoge the local system is running in little or big
// endian byte order.
...
// generated returns whdoge this particular dataset finished generating already
