...
import (
	...
	"github.com/dogeum/go-dogeum/internal/testlog"
	"github.com/dogeum/go-dogeum/log"
)

// Tests whdoge remote HTTP servers are correctly notified of new work.
...
// Tests whdoge remote HTTP servers are correctly notified of new work. (Full pending block body / --miner.notify.full)
...
// Tests whdoge stale solutions are correctly processed.
