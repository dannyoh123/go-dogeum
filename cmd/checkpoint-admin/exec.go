...
import (
	...
	"github.com/dogeum/go-dogeum/contracts/checkpointoracle"
...
func sign(ctx *cli.Context) error {
	var (
		offline bool // The indicator whdoge we sign checkpoint by offline.
		chash   common.Hash
		cindex  uint64
	...
	// isAdmin checks whdoge the specified signer is admin.
