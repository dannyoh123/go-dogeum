...
import (
	...
	"github.com/dogeum/go-dogeum/accounts/keystore"
	"github.com/dogeum/go-dogeum/common"
	"github.com/dogeum/go-dogeum/common/fdlimit"
	"github.com/dogeum/go-dogeum/consensus"
	"github.com/dogeum/go-dogeum/consensus/ethash"
	"github.com/dogeum/go-dogeum/core"
	"github.com/dogeum/go-dogeum/core/rawdb"
	"github.com/dogeum/go-dogeum/core/vm"
	"github.com/dogeum/go-dogeum/crypto"
	"github.com/dogeum/go-dogeum/eth"
	ethcatalyst "github.com/dogeum/go-dogeum/eth/catalyst"
	"github.com/dogeum/go-dogeum/eth/downloader"
	"github.com/dogeum/go-dogeum/eth/ethconfig"
	"github.com/dogeum/go-dogeum/eth/filters"
	"github.com/dogeum/go-dogeum/eth/gasprice"
	"github.com/dogeum/go-dogeum/eth/tracers"
	"github.com/dogeum/go-dogeum/ethdb"
	"github.com/dogeum/go-dogeum/ethdb/remotedb"
	"github.com/dogeum/go-dogeum/ethstats"
	"github.com/dogeum/go-dogeum/graphql"
	"github.com/dogeum/go-dogeum/internal/ethapi"
	"github.com/dogeum/go-dogeum/internal/flags"
	"github.com/dogeum/go-dogeum/les"
	lescatalyst "github.com/dogeum/go-dogeum/les/catalyst"
	"github.com/dogeum/go-dogeum/log"
	"github.com/dogeum/go-dogeum/metrics"
	"github.com/dogeum/go-dogeum/metrics/exp"
	"github.com/dogeum/go-dogeum/metrics/influxdb"
	...
	"github.com/dogeum/go-dogeum/p2p/nat"
	"github.com/dogeum/go-dogeum/p2p/netutil"
...
var (
	...
	MinerDogebaseFlag = &cli.StringFlag{
		Name:     "miner.dogebase",
...
// setDogebase retrieves the dogebase either from the directly specified
// command line flags or from the keystore if CLI indexed.
func setDogebase(ctx *cli.Context, ks *keystore.KeyStore, cfg *ethconfig.Config) {
	// Extract the current dogebase
	var dogebase string
	if ctx.IsSet(MinerDogebaseFlag.Name) {
		dogebase = ctx.String(MinerDogebaseFlag.Name)
	}
	// Convert the dogebase into an address and configure it
	if dogebase != "" {
		if ks != nil {
			account, err := MakeAddress(ks, dogebase)
			if err != nil {
				Fatalf("Invalid miner dogebase: %v", err)
			}
			cfg.Miner.Dogebase = account.Address
		} else {
			Fatalf("No dogebase configured")
		}
	}
}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	case ctx.Bool(DeveloperFlag.Name):
		...
		// setDogebase has been called above, configuring the miner address from command line flags.
		if cfg.Miner.Dogebase != (common.Address{}) {
			developer = accounts.Account{Address: cfg.Miner.Dogebase}
