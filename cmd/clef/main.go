...
import (
	...
	"github.com/dogeum/go-dogeum/cmd/utils"
	...
	"github.com/dogeum/go-dogeum/signer/core"
	"github.com/dogeum/go-dogeum/signer/core/apitypes"
	"github.com/dogeum/go-dogeum/signer/fourbyte"
	"github.com/dogeum/go-dogeum/signer/rules"
	"github.com/dogeum/go-dogeum/signer/storage"
...
func checkFile(filename string) error {
	...
	// https://github.com/dogeum/go-dogeum/issues/20123
...
func GenDoc(ctx *cli.Context) error {
	...
	{ // List request
		...
		add("ListResponse", "Response to list request. The response contains a list of all addresses to show to the caller. "+
			"Note: the UI is free to respond with any address the caller, regardless of whdoge it exists or not",
			&core.ListResponse{
				Accounts: []accounts.Account{
					{
