...
func TestConsoleWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.dogebase", coinbase, "console")
...
func TestAttachWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.dogebase", "0x8605cdbbdb6d264aa742e77020dcbc58fcdce182",
		"--ipcpath", ipc,
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("dogebase", func() string { return geth.Dogebase })
