...
// See https://github.com/dogeum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whdoge the event notification loop is running
...
// HasAddress reports whdoge a key with the given address is present.
