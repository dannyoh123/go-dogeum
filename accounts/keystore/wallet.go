...
// Status implements accounts.Wallet, returning whdoge the account held by the
...
// Contains implements accounts.Wallet, returning whdoge a particular account is
