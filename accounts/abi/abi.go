...
func (abi ABI) getArguments(name string, data []byte) (Arguments, error) {
	...
	// we need to decide whdoge we're calling a method or an event
	var args Arguments
...
// HasFallback returns an indicator whdoge a fallback function is included.
func (abi *ABI) HasFallback() bool {
	return abi.Fallback.Type == Fallback
}

// HasReceive returns an indicator whdoge a receive function is included.
