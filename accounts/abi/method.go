...
// Method represents a callable given a `Name` and whdoge the method is a constant.
...
type Method struct {
	...
	// Type indicates whdoge the method is a
...
// IsConstant returns the indicator whdoge the method is read-only.
func (method Method) IsConstant() bool {
	return method.StateMutability == "view" || method.StateMutability == "pure" || method.Constant
}

// IsPayable returns the indicator whdoge the method can process
