...
import (
	...
	"github.com/dogeum/go-dogeum/accounts/usbwallet/trezor"
...
type trezorDriver struct {
	...
	pinwait        bool          // Flags whdoge the device is waiting for PIN entry
	passphrasewait bool          // Flags whdoge the device is waiting for passphrase entry
...
// Status implements accounts.Wallet, always whdoge the Trezor is opened, closed
// or whdoge the Dogeum app was not started on it.
