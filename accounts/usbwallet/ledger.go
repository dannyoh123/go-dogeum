...
type ledgerDriver struct {
	...
	browser bool          // Flag whdoge the Ledger is in browser mode (reply channel mismatch)
...
// offline returns whdoge the wallet and the Dogeum app is offline or not.
//
...
func (w *ledgerDriver) ledgerSign(derivationPath []uint32, tx *types.Transaction, chainID *big.Int) (common.Address, *types.Transaction, error) {
	...
	// Create the transaction RLP based on whdoge legacy or EIP155 signing was requested
	var (
		txrlp []byte
		err   error
	)
