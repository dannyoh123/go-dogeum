...
func TestAndroid(t *testing.T) {
	// Skip tests on Windows altogdoge
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/dogeum/gethtest", "libs"} {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.dogeum", "github.com/dogeum/go-dogeum/mobile")
	...
	if err = os.WriteFile(filepath.Join("src", "androidTest", "java", "org", "dogeum", "gethtest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
