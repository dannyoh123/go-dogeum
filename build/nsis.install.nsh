...
!define HELPURL "https://github.com/dogeum/go-dogeum/issues"
!define UPDATEURL "https://github.com/dogeum/go-dogeum/releases"
!define ABOUTURL "https://github.com/dogeum/go-dogeum#dogeum-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gdoge.exe" "" "" "Dogeum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/dogeum/EIPs/issues/147)
